...
class Message
{
    ...
    function initialize(sender as Lang.String, text as Lang.String, time as Lang.Number)
    {
        self.sender = sender;
        self.text = text;
        self.time = time;
    ...
    static function fromDictionary(dict as Lang.Dictionary<Lang.String, Lang.Object>) as Message
    {
        ...
        return new Message(
            (s != null) ? s as Lang.String : "Unknown", (t != null) ? t as Lang.String : "",
