...
class MessengerApp extends Application.AppBase {
  ...
  function initialize() {
    ...
    _logger.info(
        "MessengerApp", "=== Set minimum debuglevel ===" + minimumDebugLevel);
  ...
  function
      getInitialView() as [WatchUi
                               .Views] or[WatchUi.Views, WatchUi.InputDelegates] {
    ...
    try {
      ...
      switch (defaultView) {
        ...
        default:
          _logger.debug(
              "MessengerApp", "=== Returning default MessagesView ===");
      ...
      _logger.debug(
          "MessengerApp", "ERROR in getInitialView: " + ex.getErrorMessage());
      // Return a minimal view as fallback
      _logger.debug(
          "MessengerApp", "=== Returning MessagesView as fallback ===");
      var messageView = new MessagesView(getMessageManager());
      return ([
        messageView, new MessagesViewDelegate(messageView)
      ] as [WatchUi.Views, WatchUi.InputDelegates]);
