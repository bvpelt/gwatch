...
class AnalogView extends WatchUi.View {
  ...
  public function updateSettings() {
    ...
    updateEverySecond =
        propertieUtility.getPropertyBoolean("UpdateSeconds", true);
    logger.debug(
        "AnalogView",
  ...
  private function loadCustomColors() {
    ...
    facebordercolor =
        propertieUtility.getPropertyNumber("FaceBorderColor", 0xc0c0c0);
    handcentercolor =
        propertieUtility.getPropertyNumber("HandCenterColor", 0xff0000);
    ...
    daynumbercolor =
        propertieUtility.getPropertyNumber("DayNumberColor", 0xa0a0a0);
    dayoutlinecolor =
        propertieUtility.getPropertyNumber("DayOutlineColor", 0xc0c0c0);
    hourmarkercolor =
        propertieUtility.getPropertyNumber("HourMarkerColor", 0xffffff);
    minutetickcolor =
        propertieUtility.getPropertyNumber("MinuteTickColor", 0xa0a0a0);
  ...
  private function drawLoad(dc) {
    ...
    dc.drawArc(
        centerX, centerY, radius * 0.92, Graphics.ARC_CLOCKWISE,
  ...
  private function drawDateInfo(dc) {
    ...
    var boxWDNameX =
        maxlen - boxWeekdayWidth - boxNumberWidth - boxSpacing;  // weekday name
