...
class MessagesView extends WatchUi.View {
  ...
  private function getTextHeight(dc as Graphics.Dc, font) {
    return dc.getFontHeight(font);
      ...
      private function getMessageIndex(
        ...
        _logger.trace(
            "MessagesView",
            "getMessageIndex maxMessages: " + maxMessages +
                " messageIndex: " + messageIndex);
        return messageIndex;
      }

      private function drawMessages(
          dc as Graphics.Dc, messages as Lang.Array<Lang.Dictionary>,
          offset as Lang.Number, width as Lang.Number, height as Lang.Number) as Void
    {
    ...
    private function drawUpArrow(dc as Graphics.Dc, y, maxMessages) {
        ...
        _logger.debug ("MessagesView", "drawUpArrow y: " + y + " _scrollOffset: " + _scrollOffset + " condition: " + condition);
    ...
    private function drawDownArrow(dc as Graphics.Dc, y, maxMessages) {
        ...
        _logger.debug ("MessagesView", "drawDownArrow y: " + y + " _scrollOffset: " + _scrollOffset + " condition: " + condition);
    ...
    private function drawMessage(dc as Graphics.Dc, font, message as Lang.Dictionary, x, y, width){
        ...
        _logger.trace("MessagesView", "Drawingmessage sender: " + sender + " text: " + text + " at (" + x + ", " + y + ")");
