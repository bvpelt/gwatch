...
.View
{
    ...
    function onUpdate(dc as Graphics.Dc) as Void
    {
        ...
        dc.drawText(
            width / 2, height / 3, Graphics.FONT_NUMBER_HOT, timeString,
            Graphics.TEXT_JUSTIFY_CENTER | Graphics.TEXT_JUSTIFY_VCENTER
        );

        // Draw seconds
        dc.drawText(
            width / 2, height / 2, Graphics.FONT_MEDIUM, clockTime.sec.format("%02d"),
            Graphics.TEXT_JUSTIFY_CENTER | Graphics.TEXT_JUSTIFY_VCENTER
        );
        ...
        dc.drawText(
            width / 2, (height * 2) / 3, Graphics.FONT_SMALL, dateString,
            Graphics.TEXT_JUSTIFY_CENTER | Graphics.TEXT_JUSTIFY_VCENTER
        );
        ...
        if (messageCount > 0) {
            ...
            dc.setColor(Graphics.COLOR_WHITE, Graphics.COLOR_TRANSPARENT);
            dc.drawText(
                width - 20, 20, Graphics.FONT_XTINY, messageCount.toString(),
                Graphics.TEXT_JUSTIFY_CENTER | Graphics.TEXT_JUSTIFY_VCENTER
            );
        }
    ...
    private function drawConnectionStatus(
        dc as Graphics.Dc, width as Lang.Number, height as Lang.Number
    ) as Void
    {
        ...
        dc.drawText(
            20, 20, Graphics.FONT_MEDIUM, statusText,
            Graphics.TEXT_JUSTIFY_CENTER | Graphics.TEXT_JUSTIFY_VCENTER
        );
    }
