...
class ClockViewDelegate extends WatchUi.BehaviorDelegate {
  ...
  /*
      ...
      // Enter long - go to AnalogView / swipe right
      function onSelectHold()
      {
          _logger.debug("ClockViewDelegate", "Enter - switching to Analog
     view");
     ...
     WatchUi.SLIDE_RIGHT);
      ...
      // Back button - go to MessagesView / swipe left
      function onBack()
      {
          _logger.debug("ClockViewDelegate", "Back - switching to Message
     view");

          var messageView = new MessagesView(getMessageManager());
          WatchUi.switchToView(messageView, new
     MessagesViewDelegate(messageView), WatchUi.SLIDE_LEFT); return true;
      }
  */
  ...
  private function goNextView() {
    ...
    WatchUi.switchToView(
        new AnalogView(), new AnalogViewDelegate(), WatchUi.SLIDE_RIGHT);
    return true;
  }
