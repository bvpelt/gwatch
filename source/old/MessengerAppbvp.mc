...
class MessengerAppbvp extends Application.AppBase
{
    ...
    function initialize ()
    {
        ...
        var minimumDebugLevel = propertieUtility.getPropertyNumber ("MinimalDebugLevel", 0);

        if (minimumDebugLevel != null) {
            logger.info ("MessengerApp",
        ...
        logger.info ("MessengerApp", "=== Set minimum debuglevel ===" + minimumDebugLevel);
  ...
  // FIXED VERSION: Use manually tracked view
  function onHeartbeat () as Void
  {
      // Use the manually tracked active view instead of getCurrentView()
      if (_activeView != null && _activeView has : onUpdateHeartbeat) {
          _activeView.onUpdateHeartbeat ();
      }
  }
  ...
  function onSettingsChanged ()
  {
      ...
      getAnalogViewbvp ().updateSettings ();
      ...
      try {
          ...
          switch (currentView) {
              case 0:
                  ...
                  return ([_activeView, _delegate] as[WatchUi.Views, WatchUi.InputDelegates]);
          ...
          logger.debug ("MessengerApp", "ERROR in getInitialView: " + ex.getErrorMessage ());
          // Return a minimal view as fallback
          _activeView = getClockViewbvp (); // ADD THIS: Track fallback view
          return ([_activeView, getMessengerDelegate ()] as[WatchUi.Views, WatchUi.InputDelegates]);
      }
  }
  ...
  {
      _activeView = view;
      logger.debug ("MessengerApp", "=== Active view changed ===");
  }
...
/*
function getAppbvp() as MessengerAppbvp {
  return Application.getAppbvp() as MessengerAppbvp;
}
*/