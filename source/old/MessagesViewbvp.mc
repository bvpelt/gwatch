...
class MessagesViewbvp extends WatchUi.View
{
    private static var _instance as MessagesViewbvp ? ;
    private var _messageManager;
    private var _scrollOffset as Lang.Number;
    private var logger;

    // Get singleton instance
    static function getInstance () as MessagesViewbvp
    {
        if (_instance == null) {
            _instance = new MessagesViewbvp (getMessageManager ());
        }
        return _instance;
    }
    ...
    function onUpdate (dc as Graphics.Dc) as Void
    {
        ...
        dc.drawText (width / 2, 10, Graphics.FONT_SMALL, "Messages", Graphics.TEXT_JUSTIFY_CENTER);
        ...
        if (messages.size () == 0) {
            dc.drawText (width / 2, height / 2, Graphics.FONT_SMALL, "No Messages",
    ...
    private function drawMessages (dc as Graphics.Dc, messages as Lang.Array<Lang.Dictionary>,
...
function getMessagesViewbvp () as MessagesViewbvp
{
    return MessagesViewbvp.getInstance ();
}
