...
class AnalogViewbvp extends WatchUi.View
{
    private static var _instance as AnalogViewbvp ? ;
    private var logger;
    ...
    private function initialize ()
    {
        ...
        logger.debug ("AnalogViewbvp", "Initializing AnalogViewbvp");
    ...
    static function getInstance () as AnalogViewbvp
    {
        if (_instance == null) {
            _instance = new AnalogViewbvp ();
        }
        return _instance;
    }
    ...
    public function updateSettings ()
    {
        ...
        logger.debug ("AnalogView", "==== Initialize AnalogView - Update every second: "
        ...
        logger.debug ("AnalogView", "==== Initializing AnalogView with profile: "
                                        + profile.toString () + " ====");
    ...
    private function drawLoad (dc)
    {
        ...
        dc.drawArc (centerX, centerY, radius * 0.92, Graphics.ARC_CLOCKWISE, startAngle,
                    startAngle - sweepAngle);

        // Red portion (remaining)
        dc.setColor (Graphics.COLOR_RED, Graphics.COLOR_TRANSPARENT);
        dc.drawArc (centerX, centerY, radius * 0.92, Graphics.ARC_CLOCKWISE,
    ...
    private function drawDateInfo (dc)
    {
        ...
        dc.drawText (boxWDNameX + boxWeekdayWidth / 2, centerYPos, font, weekday,
                     Graphics.TEXT_JUSTIFY_CENTER | Graphics.TEXT_JUSTIFY_VCENTER);
        ...
        dc.drawText (boxDNumberX + boxNumberWidth / 2, centerYPos, font, dayString,
                     Graphics.TEXT_JUSTIFY_CENTER | Graphics.TEXT_JUSTIFY_VCENTER);
    }
...
function getAnalogViewbvp () as AnalogViewbvp
{
    return AnalogViewbvp.getInstance ();
}
